INSERT INTO Location (name, address, city) VALUES
    ('Centar', 'Macedonia Square 1', 'Skopje'),
...
INSERT INTO Equipment (name, type) VALUES
    ('Dell Monitor 27"', 'Computer Equipment'),
...
INSERT INTO MembershipPlan (type, price, discount_percentage) VALUES
    ('Basic', 29.99, 5),
...
INSERT INTO CoworkingCenter (name, contact_phone, email, location_id) VALUES
    ('Hub Skopje Centar', '+389-2-555-0100', 'info@hubskopje.mk', 1),
...
INSERT INTO Workspace (name, type, capacity, status, coworking_center_id) VALUES
    ('Room 101', 'Private Office', 4, 'available', 1),
    ('Open Desk A', 'Hot Desk', 1, 'available', 1),
    ('Conference Room Alpha', 'Meeting Room', 12, 'available', 2);

INSERT INTO WorkspaceSetup (workspace_id, version_number, price_per_slot, description) VALUES
    (1, 1, 500.00, 'Standard 4-person office setup'),
...
INSERT INTO Contract (fixed_price, status, start_date, end_date, member_id) VALUES
    (25000.00, 'active', '2026-01-01', '2026-06-30', 1),
...
INSERT INTO Reservation (date, slot, status, code, responsible_member_id, setup_id, invoice_id, contract_id) VALUES
    ('2026-05-25', 'morning', 'confirmed', 'RES-SKP-015', 1, 1, NULL, NULL),
    ('2026-05-27', 'afternoon', 'pending', 'RES-SKP-020', 5, 1, NULL, NULL),
    ('2026-06-01', 'morning', 'confirmed', 'RES-SKP-025', 1, 1, NULL, NULL),
    ('2026-06-01', 'afternoon', 'confirmed', 'RES-SKP-026', 2, 1, NULL, NULL),
    ('2026-06-02', 'morning', 'confirmed', 'RES-SKP-027', 3, 1, NULL, NULL);
